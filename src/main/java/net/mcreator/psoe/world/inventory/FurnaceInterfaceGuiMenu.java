...
public class FurnaceInterfaceGuiMenu extends AbstractContainerMenu implements PsoeModMenus.MenuAccessor {
	...
	public FurnaceInterfaceGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
