...
@Mod("psoe")
public class PsoeMod {
	public static final Logger LOGGER = LogManager.getLogger(PsoeMod.class);
	public static final String MODID = "psoe";

	public PsoeMod(FMLJavaModLoadingContext context) {
