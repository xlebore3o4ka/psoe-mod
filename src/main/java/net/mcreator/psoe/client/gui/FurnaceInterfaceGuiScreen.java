...
public class FurnaceInterfaceGuiScreen extends AbstractContainerScreen<FurnaceInterfaceGuiMenu> implements PsoeModScreens.ScreenAccessor {
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	private boolean menuStateUpdateActive = false;

	public FurnaceInterfaceGuiScreen(FurnaceInterfaceGuiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("psoe:textures/screens/furnace_interface_gui.png");
